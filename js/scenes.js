/* ═══════════════════════════════════════════════
   ...
   Accordion sections, search, click-to-copy cards.
   aceenvw
   ═══════════════════════════════════════════════ */
...
(function() {
  ...
  if (!window.SCENES_DATA || !Array.isArray(window.SCENES_DATA.sections)) {
    console.error('Scenes data not loaded');
    return;
  }

  const data = window.SCENES_DATA;
  const root = document.getElementById('scenes-sections');
  const searchInput = document.getElementById('scenes-search');
  const resultCount = document.getElementById('scenes-result-count');
  ...
  function buildCard(prompt, sectionId) {
    ...
    bodyEl.setAttribute('aria-label',
      getLang() === 'ru' ? 'Скопировать промпт' : 'Copy prompt to clipboard');
  ...
  function updatePlaceholders() {
    ...
    searchInput.placeholder = getLang() === 'ru' ? 'Поиск сцен...' : 'Search scenes...';
  }
